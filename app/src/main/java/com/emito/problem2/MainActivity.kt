...
class MainActivity : AppCompatActivity() {
    val users=ArrayList<User>(
        arrayListOf(
            User("bruk","andemariam","bruk@gmail.com","bruk123"),
            User("amanuel","isack","aigemito.2006@gmail.com","emito123"),
            User("desale","hdremariam","desale@gmail.com","desale123") ,
            User("negash","mussie","negie@gmail.com","negie123"),
            User("selam","esseta","semamino@gmail.com","selam123")
        )
    )
